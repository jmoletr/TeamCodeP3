...
class StudentController extends Controller
{
    ...
    public function index(){
        ...
        return view('student', ['asignaturas'=>$asignaturas]);
    }
    ...
    public function store(Request $request){
        ...
        if($request->only('listarclass')){
            ...
            $clases = DB::table('class')
                ->select('class.name AS nameClass','class.id_class','enrollment.id_student','users.name','users.surname','courses.name','users.id AS iduser')
