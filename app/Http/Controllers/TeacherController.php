...
class TeacherController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($request->only('listarclass')){
            ...
            return view('teacher.works', ['works'=>$works, 'class'=>$clase, 'courses'=>$courses, 'students'=>$students,'allworks'=>$allworks]);
            ...
            return view('teacher.exams', ['exams'=>$exams,'class'=>$class,]);
            ...
            $allworks = DB::table('works')
                            ->select('works.*')
                            ->get();
            return view('teacher.editwork',['allworks'=>$allworks,'students'=>$students,'idthiswork'=>$idThisWork['editartrabajos'],'idstudent'=>$idstudent['idstudent'],'markwork'=>$markwork['mark_work']]);
            ...
            $clase = DB::table('class')
                ->select('class.*')
                ->get();
            return view('teacher.editexam',['class'=>$clase,'students'=>$students,'exams'=>$exam,'idexam'=>$idThisExam['editarexamenes'] ,'idstudent'=>$idstudent['idstudent'],'idclass'=>$class['idclass'],'markexam'=>$markexam['mark_exam']]);
            ...
            return view('teacher.editporcent',['students'=>$students,'clase'=>$clase,'courses'=>$courses, 'percent'=>$percent, 'idstudent'=>$idstudent,'idcourse'=>$idcourse,'idclass'=>$idclass, 'ec'=>$ec,'exam'=>$exam, 'id_percentage'=>$id_percentage]); 
